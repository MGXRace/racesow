...
enum
{
	...
	, STAT_AUTH_STATE // racesow
	, STAT_TIME_SELF
	, STAT_TIME_SELF2 // racesow
	, STAT_TIME_BEST
	, STAT_TIME_BEST2 // racesow
	, STAT_TIME_RECORD
	, STAT_TIME_RECORD2 // racesow
	, STAT_TIME_ALPHA
	, STAT_TIME_ALPHA2 // racesow
	, STAT_TIME_BETA
	, STAT_TIME_BETA2 // racesow
